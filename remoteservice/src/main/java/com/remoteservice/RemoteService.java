...
public class RemoteService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        if (IRemoteService.class.getName().equals(intent.getAction())) {
            LogUtil.d("service bind1");
            return mBinder;
        }
        if (ISecondary.class.getName().equals(intent.getAction())) {
            LogUtil.d("service bind2");
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification(R.drawable.abc_ab_share_pack_mtrl_alpha, text,
    ...
    public static class Binding extends Activity {
        ...
        private ServiceConnection mSecondaryConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                ...
                // other interface.
                LogUtil.d("onServiceConnected2");
                mSecondaryService = ISecondary.Stub.asInterface(service);
                mKillButton.setEnabled(true);
            }

            public void onServiceDisconnected(ComponentName className) {
                LogUtil.d("onServiceDisconnected2");
...
//            finalss boolean mUnbindOnDisconnect;
//
